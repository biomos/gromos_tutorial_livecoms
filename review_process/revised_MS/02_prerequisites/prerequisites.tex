...
The tutorials require the latest GROMOS version installed (1.5.0).
% Editors note:  This should be clearer.  When logging onto the site, it should be clear whether the license will be issued after a period of time.  Also, on the web page, a GROMOS96 license is listed for 400 EU, and it is unclear exactly how this is explained. Do users need a GROMOS license to download the code?  To run the code? Is this the same as the license that is on the webpage, or some other license?
...
% Editors note: suggest something more like the below instead of the above?  
% "Users can download the GROMOS source code by visiting \url{www.gromos.net} and registering.  Upon registration users may download the source code for free, as well as the PDF files for the manual. Files required for the basic tutorials in Volume 7 of the manual can also be downloaded upon registration. In addition"
%If some sort of a a license file is needed in some way, please note more clearly what is needed.
